...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'users_customuser', (
            ...
            ('pseudo', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('avatar_url', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('type', self.gf('django.db.models.fields.CharField')(default='user', max_length=20)),
        ))
