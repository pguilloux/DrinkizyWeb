...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Bar.website'
        db.alter_column(u'bars_bar', 'website', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Bar.phone'
        db.alter_column(u'bars_bar', 'phone', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Bar.website'
        db.alter_column(u'bars_bar', 'website', self.gf('django.db.models.fields.CharField')(max_length=200))

        # User chose to not deal with backwards NULL issues for 'Bar.phone'
        raise RuntimeError("Cannot reverse this migration. 'Bar.phone' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Bar.phone'
        db.alter_column(u'bars_bar', 'phone', self.gf('django.db.models.fields.CharField')(max_length=200))
