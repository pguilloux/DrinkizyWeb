...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Bar.picture'
        db.delete_column(u'bars_bar', 'picture')

        # Deleting field 'Bar.coordinates'
        db.delete_column(u'bars_bar', 'coordinates')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Bar.picture'
        raise RuntimeError("Cannot reverse this migration. 'Bar.picture' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Bar.picture'
        db.add_column(u'bars_bar', 'picture',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Bar.coordinates'
        raise RuntimeError("Cannot reverse this migration. 'Bar.coordinates' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Bar.coordinates'
        db.add_column(u'bars_bar', 'coordinates',
    ...
    models = {
        ...
        u'bars.bar': {
            ...
            'website': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200'})
        },
        u'bars.openinghours': {
