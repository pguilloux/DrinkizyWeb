...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Bar.theme'
        db.delete_column(u'bars_bar', 'theme_id')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Bar.theme'
        raise RuntimeError("Cannot reverse this migration. 'Bar.theme' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Bar.theme'
        db.add_column(u'bars_bar', 'theme',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bars.Theme']),
                      keep_default=False)
