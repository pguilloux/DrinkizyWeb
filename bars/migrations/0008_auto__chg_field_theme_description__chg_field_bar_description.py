...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'bars_theme', 'description', self.gf('django.db.models.fields.CharField')(max_length=2000))

        # Changing field 'Bar.description'
        db.alter_column(u'bars_bar', 'description', self.gf('django.db.models.fields.CharField')(max_length=3000, null=True))

    def backwards(self, orm):

        # Changing field 'Theme.description'
        db.alter_column(u'bars_theme', 'description', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Bar.description'
        db.alter_column(u'bars_bar', 'description', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
