...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DrinkCategory.description'
        db.alter_column(u'drinks_drinkcategory', 'description', self.gf('django.db.models.fields.CharField')(max_length=2000))

        # Changing field 'Drink.description'
        db.alter_column(u'drinks_drink', 'description', self.gf('django.db.models.fields.CharField')(max_length=3000))

        # Changing field 'DrinkSubCategory.description'
        db.alter_column(u'drinks_drinksubcategory', 'description', self.gf('django.db.models.fields.CharField')(max_length=2000))

    def backwards(self, orm):

        # Changing field 'DrinkCategory.description'
        db.alter_column(u'drinks_drinkcategory', 'description', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Drink.description'
        db.alter_column(u'drinks_drink', 'description', self.gf('django.db.models.fields.CharField')(max_length=2000))

        # Changing field 'DrinkSubCategory.description'
        db.alter_column(u'drinks_drinksubcategory', 'description', self.gf('django.db.models.fields.CharField')(max_length=200))
