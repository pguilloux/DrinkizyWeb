...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Drink'
        db.create_table(u'drinks_drink', (
            ...
            ('subcategory', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['drinks.DrinkSubCategory'])),
        ))
        db.send_create_signal(u'drinks', ['Drink'])

        # Adding model 'DrinkCategory'
        db.create_table(u'drinks_drinkcategory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=200)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'drinks', ['DrinkCategory'])

        # Adding model 'DrinkSubCategory'
        db.create_table(u'drinks_drinksubcategory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=200)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['drinks.DrinkCategory'])),
        ))
        db.send_create_signal(u'drinks', ['DrinkSubCategory'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'drinks_drink')

        # Deleting model 'DrinkCategory'
        db.delete_table(u'drinks_drinkcategory')

        # Deleting model 'DrinkSubCategory'
        db.delete_table(u'drinks_drinksubcategory')
